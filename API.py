    ...
    for i in range(random_number):
        data = {
            ...
            "creator": {
                ...
                "last_console_login_at": faker.date_time().strftime(
                    "%Y-%m-%d %H:%M:%S"
                ),
                "created_at": faker.date_time().strftime("%Y-%m-%d %H:%M:%S"),
                "updated_at": faker.date_time().strftime("%Y-%m-%d %H:%M:%S"),
            ...
            "tags": [
                {
                    ...
                    "updated_at": faker.date_time().strftime("%Y-%m-%d %H:%M:%S"),
                    "deleted_at": None,
                    "pivot": {"order_id": faker.uuid4(), "tag_id": faker.uuid4()},
                }
            ],
            "coupon": {
                "id": faker.uuid4(),
                    ...
                    "taxes": [
                        {
                            ...
                            "name_localized": None,
                            "rate": 5,
                            "created_at": faker.date_time().strftime(
                                "%Y-%m-%d %H:%M:%S"
                            ),
                            "updated_at": faker.date_time().strftime(
                                "%Y-%m-%d %H:%M:%S"
                            ),
                            "deleted_at": None,
                        }
            ...
            "meta": {
                "foodics": {
                    ...
                    "kitchen_received_at": faker.date_time().strftime(
                        "%Y-%m-%d %H:%M:%S"
                    ),
                    "decline_at": faker.date_time().strftime("%Y-%m-%d %H:%M:%S"),
                    "joined_orders": [faker.uuid4()],
                }
            },
